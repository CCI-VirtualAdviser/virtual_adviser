...
1  Unwatch 
  Star 0
 Fork 1CCI-VirtualAdviser/virtual_adviser
 branch: master  virtual_adviser/database/student2.php
dfarthi1dfarthi1 28 seconds ago Create student2.php
1 contributor
447 lines (398 sloc)  22.6 kb RawBlameHistory   
<?php 
session_start();
$username = 'root';
$password = 'root';
